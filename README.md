...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-panels-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10915&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-panels-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-panels` can be installed with:

```
conda install sphinx-panels
```

It is possible to list all of the versions of `sphinx-panels` available on your platform with:
